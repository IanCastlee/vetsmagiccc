...
const TreatedPets = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataAppend.append("pet_name", formData.petname);

    try {
      const res = await axiosIntance.post(
        "admin/treatedpets/addTreatedPet.php",
        formDataAppend,
        {
          headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await axiosIntance.post(
        "admin/treatedpets/updateTreatedPet.php",
        formDataAppend,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const res = await axiosIntance.post(
        `admin/treatedpets/deleteTreatedPet.php?pet_id=${showDelForm}`
      );

      if (res.data.success) {
        console.log("RES : ", res.data.message);

        setData((prevData) => prevData.filter((d) => d.pet_id !== showDelForm));
    ...
    <>
      <div className="admin-shop">
        <div className="top">
          <div className="left">
            <h3>
              <MdOutlineMedicalServices /> Treated Pets
            </h3>
          </div>
          <div className="right">
                    ...
                    <tr key={index}>
                      ...
                      <td className="btns-wrapper">
                        <button title="Delete" className="btn">
                          <FaTrashAlt
                            className="icon"
                            onClick={() => setShowDelForm(item.pet_id)}
                          />
                        </button>
                        <button
                          title="Edit"
            ...
            <div className="container">
              ...
              >
                <div className="form-wrapper">
                  ...
                  >
                    <label htmlFor="petname">Type</label>
      ...
      {showDelForm !== null && (
        <div className="delete-overlay">
          ...
          >
            ...
            <p>Are you sure you want to remove this Treated Pet?</p>
