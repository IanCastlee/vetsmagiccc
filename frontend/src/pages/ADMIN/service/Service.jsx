...
const Service = () => {
  ...
  const fetchedData = async () => {
    try {
      const res = await axiosIntance.get("admin/service/getservice.php");
      if (res.data.success) {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await axiosIntance.post(
        "admin/service/updateservice.php",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const handleDelete = async (e) => {
    ...
    try {
      const res = await axiosIntance.post(
        `admin/service/removeservice.php?service_id=${showDelForm}`
      );
      ...
      if (res.data.success) {
        ...
        setData((prevData) =>
          prevData.filter((d) => d.service_id !== showDelForm)
        );
                    ...
                    <tr key={index}>
                      ...
                      <td className="btns-wrapper">
                        <button title="Delete" className="btn">
                          <FaTrashAlt
                            className="icon"
                            onClick={() => setShowDelForm(item.service_id)}
                          />
                        </button>
                        <button
                          title="Edit"
