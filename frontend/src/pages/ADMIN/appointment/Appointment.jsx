...
const Appointment = () => {
  ...
  // ======================================
  // 📌 PDF EXPORT – COMPLETED APPOINTMENTS
  // ======================================
  const downloadCompletedAppointmentPDF = () => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(13);
    doc.text("Completed Appointment", pageWidth / 2, 28, { align: "center" });
    ...
    // DATA (COMPLETED ONLY)
    const allData = filteredData.filter((x) => x.status === 1);
    ...
    doc.save("Completed_Appointments.pdf");
  };
        ...
        <div className="top">
          ...
          <div className="right">
            ...
            <button
              ...
              title="Download PDF"
              onClick={downloadCompletedAppointmentPDF}
            >
              Download PDF
            </button>
