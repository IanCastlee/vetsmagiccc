...
const CancelledAppointment = () => {
  ...
  // =========================
  // 📌 PDF EXPORT – CANCELLED APPOINTMENTS
  // =========================
  const downloadCancelledAppointmentPDF = () => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(13);
    doc.text("Cancelled Appointment", pageWidth / 2, 28, { align: "center" });
    ...
    autoTable(doc, {
      ...
      columnStyles: { 0: { halign: "center" }, 12: { halign: "center" } },
    });
    ...
    doc.save("Cancelled_Appointments.pdf");
  };
        ...
        <div className="top">
          ...
          <div className="right">
            ...
            <button
              ...
              title="Download PDF"
              onClick={downloadCancelledAppointmentPDF}
            >
              Download PDF
            </button>
            ...
            <tbody>
              {currentData.length > 0 ? (
                ...
                <tr>
                  <td
                    colSpan={15}
                    style={{ textAlign: "center", padding: 10, color: "#888" }}
                  >
                    No data available
                  </td>
                </tr>
