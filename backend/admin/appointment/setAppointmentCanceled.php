...
if (isset($_GET['appointment_id']) && isset($_GET['note_from_vet']) && isset($_GET['client_id'])) {
    ...
    $note_from_vet = $_GET['note_from_vet']; // this is your reason / note
    ...
    if ($update_status->execute()) {
        ...
        //  Insert into cancellation_reason table
        $insertReason = $conn->prepare("INSERT INTO cancellation_reason (appointment_id, reason) VALUES (?, ?)");
        $insertReason->bind_param("is", $appointment_id, $note_from_vet);
